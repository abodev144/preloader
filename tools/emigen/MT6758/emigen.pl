...
#=cut
    ...
    unless($ENV{PROJECT} eq "mt6758_evb"){
...
sub write_tag()
{
    ...
    print FILE pack("a24", "MTK_BLOADER_INFO_v31"); #MT6758
...
sub write_tag_one_element()
{
    ...
    print FILE pack ("L", hex (lc($DIS_CBT_MODE_EXTERN_TYPE[$id]))) ;     # DIS_CBT_MODE_EXTERN
    $fs = $fs + 4 ;
